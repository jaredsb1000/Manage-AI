...
class GumroadManager:
    ...
    def create_receipt_product(self, character, art_url, price):
        ...
        # FIX: Gumroad usually expects price in Cents (e.g., 500 cents = $5.00)
        ...
        try:
            ...
            # DEBUG: Print status code and body
            ...
            if response.status_code == 201:
                ...
                print(f"-> [ERROR] Gumroad Rejected Request.")
                return None
...
class Manage:
    def __init__(self):
        ...
        print(f"Manage v8.2 Online - Debugging Price & Auth.")
